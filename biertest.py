...
from visualizations import (
    visualize_alcohol_per_beer,
    visualize_ratings,
    visualize_ratings_per_person,
    visualize_ratings_per_price,
)


def generate_plots(dataset, target, is_overall=False):
    """Generate all plots for a given dataset."""
    # Load data
...
if __name__ == "__main__":
    ...
    generate_plots(
        [
            "data/ratings_2021-05-13.csv",
            "data/ratings_2021-06-02.csv",
            "data/ratings_2021-06-30.csv",
